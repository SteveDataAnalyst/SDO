...
if "load_state_9" not in st.session_state:
    st.session_state["load_state_9"] = False
...
if submit_answer or st.session_state.load_state_9:
    st.session_state.load_state_9 = True
    placeholder1.empty()
